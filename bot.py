...
main_menu = ReplyKeyboardMarkup(
    keyboard=[
        ...
        [KeyboardButton(text="Тестовое поздравление")],  # временная кнопка
    ],
...
@dp.message(lambda m: m.text == "Тестовое поздравление")
async def test_congrats(message: types.Message):
    ...
    # Для теста выводим поздравление для всех
